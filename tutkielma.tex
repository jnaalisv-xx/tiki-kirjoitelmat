...
\subsection{Funktiot}
Yll‰tt‰en Haskell-ohjelmoijan perustyˆkalu on funktio. Luvun neliˆn palauttava funktio m‰‰ritell‰‰n n‰in:
\begin{verbatim}
neliˆ x = x * x
\end{verbatim}
