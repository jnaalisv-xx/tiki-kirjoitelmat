...
Haskell tarjoaa yksinkertaisen rakenteen jolla määritellä \texttt{tyyppisynonyymeja} (type synonyms). Esimerkiksi Haskell 98 -standardissa \texttt{String} on määritelty tyyppisynonyymiksi merkkitaulukolle (\texttt{[Char]}). Tyyppisynonyymeja määritellään seuraavan esimerkin mukaan.
\begin{verbatim}
type String = [Char]
